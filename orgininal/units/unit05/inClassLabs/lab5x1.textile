...
<br />Note: Use "&lt;pre&gt;" tags so that *@print_r()@* displays each element of the array on its own line.
...
h3. Exercise 2 - Associative Arrays
...
# Use the *@array_values()@* function to create an array named $values from the values of the $properties array. Then use *@var_dump()@* to display the contents of your $values array.
